...
func debugGraphBuilder() []graph.Edge {
	...
	g = append(g, graph.Edge{From: 4, To: 8, Capacity: 100, Cost: 1})
	g = append(g, graph.Edge{From: 5, To: 8, Capacity: 100, Cost: 1})
	g = append(g, graph.Edge{From: 6, To: 8, Capacity: 100, Cost: 1})
	g = append(g, graph.Edge{From: 7, To: 8, Capacity: 100, Cost: 1})
